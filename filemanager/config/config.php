...
$upload_dir = $_SESSION["RF"]["baseURL"].'uploads/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../uploads/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../uploads/thumbs/genreral/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$default_language 	= "vi_VN"; //default language file name
...
$fixed_path_from_filemanager            = array('../uploads/thumbs/150/','../uploads/thumbs/600/'); //fixed path of the image folder from the current position on upload folder
...
$fixed_image_creation_width             = array(150,600); //width of image (you can leave empty if you set height)
$fixed_image_creation_height            = array(150,398); //height of image (you can leave empty if you set width)
/*
#             $option:     0 / exact = defined size;
#                          1 / portrait = keep aspect set height;
#                          2 / landscape = keep aspect set width;
