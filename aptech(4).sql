...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2015 at 11:13 AM
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COLLATE=utf8_vietnamese_ci;
...
INSERT INTO `theloai` (`maTheLoai`, `tenTheLoai`, `maTheLoaiCha`) VALUES
(1, 'Parent 1', NULL),
(2, 'Parent 2', NULL),
(3, 'Child 1', 1),
(4, 'Child 2', 1),
...
--
ALTER TABLE `baiviet`
MODIFY `maBaiViet` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `phanloai`
MODIFY `sTT` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=41;
--
