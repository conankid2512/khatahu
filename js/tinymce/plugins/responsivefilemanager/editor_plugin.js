		...
		init : function(editor, url)
		{
			...
			function openmanager() 
			{
				...
				win = editor.windowManager.open({
					title: title,
					file: editor.settings.external_filemanager_path+'dialog.php?type=4&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&akey='+akey+'&relative_url=1',
					width: 860,
					height: 570,
					inline: 1,
					resizable: true,
			...
			function filemanager (id, value, type, win) {
				...
				tinymce.activeEditor.windowManager.open({
					title: title,
					file: editor.settings.external_filemanager_path+'dialog.php?type='+urltype+'&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&akey='+akey+'&relative_url=1',
					width: 860,  
					height: 570,
					resizable: true,
					maximizable: true,
