...
?>
        ...
        ?>
              <div class="col-xs-16 col-sm-8  wow fadeInLeft animated science" data-wow-delay="0.5s" data-wow-offset="130">
                ...
                <div class="row <?php if($i % 2 == 1) echo "left-bordered" ?> ">
                  <div class="topic col-sm-16"> <a href="<?php echo layTuyChon("urlChinh")."?chucnang=baiViet&maBaiViet=".$theLoai["baiViet"][0]["maBaiViet"];?>"><img class="img-thumbnail" src="<?php echo str_replace("/uploads/source",$_SESSION["baseURL"]."uploads/thumbs/600",$theLoai["baiViet"][0]["hinhNho"]) ; ?>" alt="<?php echo $theLoai["baiViet"][0]["tenBaiViet"]; ?>"/>
                    ...
                    <div class="text-danger sub-info-bordered ">
                      ...
                      <div class="comments" title="<?php echo $theLoai["baiViet"][0]["luotBinhLuan"]; ?> lượt bình luận"><span class="ion-chatbubbles icon"></span><?php echo $theLoai["baiViet"][0]["luotBinhLuan"]; ?></div>
                      <div class="views" title="<?php echo $theLoai["baiViet"][0]["luotXem"]; ?> lượt xem"><span class="ion-eye icon"></span><?php echo $theLoai["baiViet"][0]["luotXem"]; ?></div>
                    </div>
                    </a>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-13 col-md-12">
                            ...
                            <div class="text-danger sub-info">
                              ...
                              <div class="comments" title="<?php echo $theLoai["baiViet"][1]["luotBinhLuan"]; ?> lượt bình luận"><span class="ion-chatbubbles icon"></span><?php echo $theLoai["baiViet"][1]["luotBinhLuan"]; ?></div>
                              <div class="views" title="<?php echo $theLoai["baiViet"][1]["luotXem"]; ?> lượt xem"><span class="ion-eye icon"></span><?php echo $theLoai["baiViet"][1]["luotXem"]; ?></div>
                            </div>
                          </div>
                        </div>
                        </a> </li>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-13 col-md-12">
                            ...
                            <div class="text-danger sub-info">
                              ...
                              <div class="comments" title="<?php echo $theLoai["baiViet"][2]["luotBinhLuan"]; ?> lượt bình luận"><span class="ion-chatbubbles icon"></span><?php echo $theLoai["baiViet"][2]["luotBinhLuan"]; ?></div>
                              <div class="views" title="<?php echo $theLoai["baiViet"][2]["luotXem"]; ?> lượt xem"><span class="ion-eye icon"></span><?php echo $theLoai["baiViet"][2]["luotXem"]; ?></div>
                            </div>
                          </div>
                        </div>
                        </a> </li>
