        ...
        <form role="form" id="templatemo-preferences-form" data-toggle="validator" action="" method="POST">
            <div class="row">
                <div class="col-md-12 margin-bottom-15 form-group">
                    ...
                    <input class="form-control" id="tenBaiViet" value="" type="text" name="tenBaiViet" data-error="Vui lòng nhập tựa bài viết" required />
            ...
            <div class="row">
                <div class="col-md-8 margin-bottom-15 form-group">
                    ...
                    <textarea class="form-control" rows="3" id="noiDung" name="noiDung" style="width: 100%;height: 500px"></textarea>
                </div>
                <div class="col-md-4">
                    <div class="row margin-bottom-30 form-group">
                        ...
                        <select class="form-control" id="trangThai" name="trangThai">
                            ...
                            <?php if($dangNhap->kiemTraQuyenHan() <= 1) echo "<option value=\"1\">Chờ duyệt</option>"; ?>
                            <?php if($dangNhap->kiemTraQuyenHan() > 1) echo "<option value=\"2\">Đã duyệt</option>"; ?>
                        </select>
                        <div class="help-block with-errors"></div>                       
                    </div>
                    <div class="row margin-bottom-30 form-group">
                        ...
                        <div class="input-group">
                    	    <input data-remote="<?php echo layTuyChon("urlChinh"); ?>kiemTraHinhAnh.php" class="form-control" id="hinhNho" name="hinhNho" data-error="Hình đại diện không hợp lệ! Vui lòng chọn hình đại diện từ thư viện hình." value="" type="text" required />
                    ...
                    <div class="row margin-bottom-30 form-group">
                        ...
                        <table class="table table-striped" id="dStheLoai">
                            ...
                            <?php foreach($dSTheLoai_data as $theLoai_data) { ?>
                                <tr>
                                    <td><input type="checkbox" name="theLoai[]" value="<?php echo $theLoai_data["maTheLoai"]; ?>" /></td>
