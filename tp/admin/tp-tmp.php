        ...
        <form role="form" id="templatemo-preferences-form" data-toggle="validator" action="" method="POST">
            <div class="row">
                <div class="col-md-12 margin-bottom-15 form-group">
                    ...
                    <input class="form-control" pattern="^([_a-z0-9]){3,64}$" id="tenDangNhap" value="" type="text" name="tenDangNhap" data-minlength="3" maxlength="64" data-error="Tối thiểu 3, tối đa 64 ký tự chữ thường, số, và &quot;_&quot;" required />
            ...
            <div class="row">
                <div class="col-md-6 margin-bottom-15 form-group">
                    ...
                    <input class="form-control" type="password" id="matKhau" name="matKhau" data-minlength="8" data-error="Mật khẩu tối thiểu 8 ký tự" required />
                    <div class="help-block with-errors"></div>
                </div>
                <div class="col-md-6 margin-bottom-15 form-group">
                    <label for="nhapLaiMatKhau">Xác nhận mật khẩu</label>
                    <input class="form-control" type="password" id="nhapLaiMatKhau" name="nhapLaiMatKhau" data-match="#matKhau" data-error="Xác nhận mật khẩu không trùng khớp" required />
                    <div class="help-block with-errors"></div>  
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 margin-bottom-15 form-group">
                    ...
                    <input class="form-control" id="tenHienThi" value="" type="text" name="tenHienThi" data-minlength="3" maxlength="64" data-error="Tối thiểu 3, tối đa 64 ký tự" required />
                    <div class="help-block with-errors"></div>                  
                </div>
                <div class="col-md-6 margin-bottom-15 form-group">
            ...
            <div class="row">
                <div class="col-md-12 margin-bottom-15 form-group">
                    ...
                    <textarea class="form-control" rows="3" id="moTaNgan" name="moTaNgan" style="width: 100%;"></textarea>
                </div>
            </div>
...
tinymce.init({
    ...
    toolbar2: "cut copy paste bullist numlist outdent indent blockquote removeformat subscript superscript hr forecolor backcolor | table | link unlink | emoticons image media responsivefilemanager",
